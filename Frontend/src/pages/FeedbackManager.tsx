...
const FeedbackManager = () => {
  ...
  return (
    <div className="p-8 bg-transparent min-h-screen text-white">
      ...
      {/* FORM CARD */}
      <div className="bg-[#0f172a] rounded-2xl border border-white/10 p-6 mb-10 max-w-2xl shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            className="w-full bg-white/5 border border-white/10 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-white"
          />
          ...
          <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-lg hover:scale-105 transition">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        {feedbacks.map((fb)=>(
          <div
            key={fb.id}
            className="bg-[#0f172a] border border-white/10 p-5 rounded-2xl shadow-xl hover:shadow-blue-500/20 hover:scale-[1.02] transition"
          >
